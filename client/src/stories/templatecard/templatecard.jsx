...
export default function TemplateCard({ title, body, type, active, social }) {
  return (
    <div className='w-full flex items-center justify-between cursor-pointer pl-6 pr-6 rounded-lg border border-white hover:border-third-gray h-20 mb-5'>
